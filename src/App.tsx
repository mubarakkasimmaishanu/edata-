  ...
  const syncTransactions = async (silent = true) => {
    try {
      ...
      const mappedTx: Transaction[] = ((txRes && txRes.data) || txRes || []).map((t: any) => ({
        ...
        serialNumber: t.serial_number || t.serial || t.serial_no || t.serialNo || t.serial_num || t.sn || t.card_serial || null,
        pin: t.pin || t.token || t.tokens || t.pin_code || t.result_checker_pin || null,
        pins: t.pins || t.cards || null,
        rawDescription: t.description || null,
